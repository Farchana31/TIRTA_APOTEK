...
if($_POST){
    ...
    if(empty($nama)){
        ...
        include "koneksi.php";
        $insert=mysqli_query($conn,"insert into user (nama, gender, alamat, telepon, username, password) value ('".$nama."','".$gender."','".$alamat."','".$telepon."','".$username."','".md5($password)."')") or die(mysqli_error($conn));
        if($insert){
